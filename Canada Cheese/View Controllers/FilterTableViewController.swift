...
class FilterTableViewController: UITableViewController {
    ...
    var filters = [
        ...
        "Cheese type": ["Soft Cheese", "Semi-soft Cheese", "Firm Cheese", "Hard Cheese", "Veined Cheese", "Fresh Cheese"],
        "Milk type": ["Ewe", "Ewe and Goat", "Goat", "Cow", "Cow and Goat", "Buffalo Cow"],
        "Milk treatment": ["Raw Milk", "Pasteurized", "Thermised"],
        "Rind type": ["Washed Rind", "Brushed Rind", "No Rind"]
    ]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.filter.text = filters["Organic"]![0]
